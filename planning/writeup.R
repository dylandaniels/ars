...
png(filename="standard_normal.png")
hist(samples,probability=TRUE,main=NULL)
plot(dnorm,xlim=c(-3,3),add=TRUE,col="blue",main='Standard Normal')
title(main='Standard Normal')
dev.off()
...
png(filename="uniform.png")
hist(samples,probability=TRUE,main=NULL)
plot(dunif,xlim=c(0,1),add=TRUE,col="blue",main='Uniform(0,1)')
...
png(filename="gamma.png")
hist(samples,probability=TRUE,main=NULL)
plot(ddgamma,xlim=c(0,10),add=TRUE,col="blue",main='Gamma(4,5)')
title(main='Gamma(4,5)')
dev.off()
...
png(filename="beta.png")
hist(samples,probability=TRUE,main=NULL)
plot(ddbeta,xlim=c(0,10),add=TRUE,col="blue",main='Beta(2,2)')
title(main='Beta(2,2)')
dev.off()
...
png(filename="chisq.png")
hist(samples,probability=TRUE,main=NULL)
plot(ddchisqu,xlim=c(0,20),add=TRUE,col="blue",main='Chi-squared(4)')
title(main='Chi-squared(4)')
dev.off()
